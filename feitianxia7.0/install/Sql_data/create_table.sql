...
DROP TABLE IF EXISTS `ftxia_ftxrobots`;
CREATE TABLE `ftxia_ftxrobots` (
...
DROP TABLE IF EXISTS `ftxia_robots_other`;
CREATE TABLE `ftxia_robots_other` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(500) NOT NULL,
  `other_id` int(11) NOT NULL,
  `other_cates` varchar(500) NOT NULL,
  `shop_type` varchar(50) NOT NULL,
  `start_coupon_rate` varchar(50) NOT NULL,
  `end_coupon_rate` varchar(50) NOT NULL,
  `start_price` varchar(50) NOT NULL,
  `end_price` varchar(50) NOT NULL,
  `ems` int(11) NOT NULL,
